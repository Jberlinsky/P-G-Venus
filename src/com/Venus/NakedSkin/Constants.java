...
public class Constants {
    ...
    public final static String TUTORIAL_MESSAGE = "Hi there, goddess!\n" +
        "Your journey to Naked Skin® starts now. Click “okay” to learn how"  +
        "this app is going to make your journey easier.";
    public final static String TUTORIAL_SCHEDULE_MESSAGE = "Simply go to the Calendar View to view both past and upcoming treatments (circled in blue) " +
        "as well as today’s date (circled in white).  Click on any blue circled date " +
    	"to see the details of your appointment with Naked Skin®.";
    ...
    public final static String TUTORIAL_HOWTO_MESSAGE = "Check out short videos to learn how Naked Skin® works.";
    ...
    public final static String TUTORIAL_SETTINGS_MESSAGE = "You can change how you want to be reminded under Reminders.  Now you’re ready to get started.";
